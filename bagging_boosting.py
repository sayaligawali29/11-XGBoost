# -*- coding: utf-8 -*-
"""
Created on Wed Feb 14 16:17:02 2024
...
for iterclf,iterlabel in zip([weak_l1,weak_l2,weak_l3,stackingclf],['K-nearest Neighbor Model','Naive Bayes model','Stacking classifier model']):scores=model_selection.cross_val_score(iterclf,X_train,y_train,cv=3,scoring='accuracy')
